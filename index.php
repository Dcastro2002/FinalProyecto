...
<head>
    ...
    <title>Tienda Online Lebuhs</title>
    <!-- Favicon-->
...
<body>
    <a href="CS_USUARIO.php" class="btn-Cerrar" id="btnCerrar">CERRAR SESIÓN</span></a>
    <a href="#" class="btn-flotante" id="btnCarrito">Carrito <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">LEBUHS</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Tienda Online Lebuhs</h1>
                <p class="lead fw-normal text-white-50 mb-0">Lebuhs de todo a tu servicio</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Lebuhs 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
